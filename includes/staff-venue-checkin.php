...

{
    ...
    try {
        ...
        if ($rows === []) {
            ...
            return $base . ' Register for today\'s event with the same Gmail, or sign in with the Google account you used when registering.';
    ...
    return $base . ' Open Shifts to confirm today\'s event is approved on this Gmail.';
...

{
    ...
    try {
        ...
        $result = recordCheckin($pdo, $regId, 'self', $gps);
