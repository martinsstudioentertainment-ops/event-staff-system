...
function getDefaultWebsiteContent(): array
{
    return [
        'global' => [
            ...
            'notice_enabled' => true,
            'notice_items'   => [
                'This is a free registration portal for PSA-licensed security staff (DSP and static guards) to find event shifts — we are not a security company, employer, or payroll provider.',
                'Listings are for licensed security work only, not stewarding. We do not hire you, issue PSA licences, or pay wages.',
        ...
        'home' => [
            ...
            'hero_lead'     => 'Helping PSA-licensed security staff find door supervisor and static shifts at festivals, concerts, and venues. Register online, pick the shifts you want, and we will guide you through the rest.',
            ...
            'preview_desc'  => 'Door Supervisor (DSP) and Static Security — PSA-licensed registrations only.',
        ...
        'roles' => [
            ...
            'subtitle'    => 'PSA-licensed security only (Door Supervisor or Static). Pick the role that matches your licence when you register.',
