...
function getWorkHoursList(PDO $pdo, int $eventId = 0, string $workDate = ''): array
{
    ...
    $sql = "SELECT a.id AS attendance_id, a.checked_in_at, a.check_in_gps_at, a.activated_at,
                   a.attendance_status, a.work_end_at, a.bib_number,
                   ...
                   sr.gender, sr.staff_role, sr.assigned_bib_number,
