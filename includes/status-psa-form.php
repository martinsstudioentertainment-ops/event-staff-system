    ...
    <form method="post" action="status.php?token=<?= h(urlencode($token)) ?>" enctype="multipart/form-data" class="status-psa-form">
        ...
        <div class="form-grid form-grid--compact">
            ...
            <div class="form-group form-group--full">
                ...
                <input class="form-input form-input--file" type="file" id="status_psa_front" name="psa_front_image" accept="image/*"<?= empty($staff['psa_front_image']) ? ' required' : '' ?>>
            ...
            <div class="form-group form-group--full">
                ...
                <input class="form-input form-input--file" type="file" id="status_psa_back" name="psa_back_image" accept="image/*"<?= empty($staff['psa_back_image']) ? ' required' : '' ?>>
