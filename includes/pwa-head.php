...
/** @var bool|null $enablePwa Load manifest / install meta (registration site only) */
...
$pwaShort   = $pdo ? getSiteName($pdo) : 'Event Staff';
if (mb_strlen($pwaShort) > 12) {
    $pwaShort = mb_substr($pwaShort, 0, 12);
}
?>
<?php if ($enablePwa): ?>
<link rel="manifest" href="<?= htmlspecialchars($assetBase, ENT_QUOTES, 'UTF-8') ?>manifest.php">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="<?= htmlspecialchars($pwaShort, ENT_QUOTES, 'UTF-8') ?>">
<link rel="apple-touch-icon" href="<?= htmlspecialchars($assetBase, ENT_QUOTES, 'UTF-8') ?>api/pwa-icon.php?size=192">
<?php endif; ?>
