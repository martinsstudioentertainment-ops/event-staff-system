...
require_once __DIR__ . '/../services/MobileOfflineSyncService.php';
...
function mobileSyncControllerOffline(PDO $pdo): void
{
    $auth = mobileRequireAuth($pdo);
    $GLOBALS['mobile_audit']['staff_id'] = $auth['staff_id'];

    $body   = mobileParseJsonBody();
    $result = mobileOfflineSyncServiceProcess($pdo, $auth['staff'], $body);
