...
try {
    ...
    error_log('[EventStaff] signin-location-verify DB: ' . $e->getMessage());
...
try {
    ...
    error_log('[EventStaff] signin-location-verify: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['ok' => false, 'error' => 'Location verification failed.']);
}
