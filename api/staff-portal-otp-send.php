...
try {
    $pdo    = getDB();
    $result = staffPortalEmailOtpSend($pdo, $email);
    ...
    error_log('[EventStaff] staff-portal-otp-send: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['ok' => false, 'error' => 'Could not send verification code.', 'code' => 'SERVER_ERROR']);
}
