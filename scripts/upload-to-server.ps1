...
$files = @(
    ...
    @{ Local = 'includes\mobile\services\MobileEmailOtpAuthService.php'; Remote = 'includes/mobile/services/MobileEmailOtpAuthService.php' },
    ...
    @{ Local = 'api\registration-google-verify.php'; Remote = 'api/registration-google-verify.php' },
    ...
    @{ Local = 'includes\app-build-version.php'; Remote = 'includes/app-build-version.php' },
    @{ Local = 'includes\staff-app-v3-pages.php'; Remote = 'includes/staff-app-v3-pages.php' },
    @{ Local = 'includes\admin\system-health.php'; Remote = 'includes/admin/system-health.php' },
    @{ Local = 'admin\system-health.php'; Remote = 'admin/system-health.php' },
    @{ Local = 'storage\app\version.json'; Remote = 'storage/app/version.json' },
    @{ Local = 'includes\mobile\services\MobileAuthService.php'; Remote = 'includes/mobile/services/MobileAuthService.php' },
