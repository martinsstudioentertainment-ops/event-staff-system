    ...
    function applyFields(fields) {
        ...
        if (googleEmail) {
            ...
            if (hiddenEl) {
                ...
                hidden.type = 'hidden';
                hidden.name = 'registration_verified_email';
                hidden.id = 'registration_verified_email';
                hidden.value = googleEmail;
                form.insertBefore(hidden, form.firstChild);
                var legacy = document.createElement('input');
                legacy.type = 'hidden';
                legacy.name = 'registration_verified_google_email';
                legacy.id = 'registration_verified_google_email';
                legacy.value = googleEmail;
                form.insertBefore(legacy, form.firstChild);
            }
        }
    }
