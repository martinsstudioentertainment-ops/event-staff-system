...
$rows[] = ['Google sign-in required', isStaffGoogleSigninRequired($pdo) ? 'pass' : 'warn', isStaffGoogleSigninRequired($pdo) ? 'Yes (Google only on staff app)' : 'No (email OTP + PPS available when enabled)'];
