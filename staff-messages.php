...
<body class="staff-auth-v3 staff-public-shell staff-public-shell--event-ops staff-public-shell--narrow login-page staff-mobile-page" data-pwa-install="1" <?= renderStaffPortalBodyAttributes($portalStaff, $pdo) ?>>
    <?php renderStaffPublicBackground(true); ?>
    <?php renderStaffPublicHeader($pdo, $siteName, ['home_url' => 'staff-app.php', 'portal_staff' => $portalStaff, 'theme_toggle' => false]); ?>
